...
async function run() {
  ...
  try {
    ...
    for ( const t of tagsRes.data ) {
      try {
        ...
        console.error( 'Error tag', t.attributes.title ) 
      }
    }
  } catch( e ) {
    console.log( 'Skipping Tags', e ) 
  }
  ...
  try {
    ...
    for ( const s of skillsRes.data ) {
      try {
        ...
        console.error( 'Error skill', s.attributes.name ) 
      }
    }
  } catch( e ) {
    console.log( 'Skipping Skills', e ) 
  }
  ...
  try {
    ...
    for ( const p of projectsRes.data ) {
      try {
        ...
        console.error( 'Error project', p.attributes.title, e ) 
      }
    }
  } catch( e ) {
    console.log( 'Skipping Projects', e ) 
  }
  ...
  try {
    ...
    for ( const a of articlesRes.data ) {
      try {
        ...
        console.error( 'Error article', a.attributes.title, e ) 
      }
    }
  } catch( e ) {
    console.log( 'Skipping Articles', e ) 
  }
  ...
  try {
    ...
    console.log( 'Skipping Profile:', e.message ) 
  }
  ...
  try {
    ...
    console.log( 'Skipping Site:', e.message ) 
  }
  ...
  try {
    ...
    console.log( 'Skipping HomePage:', e.message ) 
  }
