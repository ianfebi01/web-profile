              ...
              case "LinkedIn":
                return (
                  <React.Fragment key={`linkedin-${i}`}>
                    ...
                    />
                    <span key={`dot-linkedin-${i}`} className="last:hidden">
                      •
                    </span>
                  </React.Fragment>
                );
              ...
              case "Instagram":
                return (
                  <React.Fragment key={`instagram-${i}`}>
                    ...
                    />
                    <span key={`dot-instagram-${i}`} className="last:hidden">
                      •
                    </span>
                  </React.Fragment>
                );
                ...
                return (
                  <React.Fragment key={`email-${i}`}>
                    <div className="flex flex-row items-center gap-2">
                      <CopyToClipboard copyText={url} className="text-md" />
                    </div>
                    <span key={`dot-email-${i}`} className="last:hidden">
                      •
                    </span>
                  </React.Fragment>
                );
